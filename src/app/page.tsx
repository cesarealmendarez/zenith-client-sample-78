...
export default function Index() {
    return (
        <div className="w-full">
            <div className="max-w-7xl mx-auto grid grid-cols-7 gap-16 pt-36">
                ...
                <div className={`${bungee.className} col-span-4 flex flex-col items-start justify-start space-y-4 pr-0`}>
                    ...
                    <p className={`${montserrat.className} text-left text-xl text-orange-950 font-light`}>
